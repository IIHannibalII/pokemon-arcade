...
/* ============================================================
   AstroMemory — 8-bit sound via WebAudio.
   Soft card flips and a dreamy original loop.
   ============================================================ */
...
(function (NS) {
  ...
  const sfx = {
    flip()  { blip(380, 0.04, 'triangle', 0.35, 120); },
    match() { arpeggio([76, 81, 85], 0.05, 0.11, 'triangle', 0.45); },
    miss()  { blip(180, 0.09, 'square', 0.3, -40); },
    win()   { arpeggio([72, 76, 79, 84, 88, 91, 96], 0.08, 0.18, 'square', 0.4); },
  };

  /* Dreamy original loop: 8 bars of 4/4 at 88 BPM. */
  const TEMPO_EIGHTH = 60 / 88 / 2;
